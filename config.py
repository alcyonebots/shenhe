...
BOT_TOKEN = getenv("BOT_TOKEN", "8091340627:AAHhcquuV3UTvDatr6YQKBjPjt2qeMW8TRs")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002854086015"))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6663845789"))
